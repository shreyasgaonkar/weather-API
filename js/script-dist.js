...
$(document).ready(function () {
  ...
  function getCity() {
    ...
    $.get("http://api.ipstack.com/check?access_key=" + config.IPSTACK_API_ID).then(function (data) {
      console.log(data);
  ...
  function getWeather() {
    ...
    city = $('#input-city').val();
    var url = "//api.openweathermap.org/data/2.5/weather?q=" + city + "&units=" + unit + "&appid=" + config.API_ID;
    ...
    function getData(data) {
      ...
      $('#temperature > h1').mouseenter(function () {
